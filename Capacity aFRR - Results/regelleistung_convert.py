...
base_url = "https://www.regelleistung.net/apps/cpp-publisher/api/v1/download/tenders/resultsoverview?date={}&exportFormat=xlsx&market=CAPACITY&productTypes=aFRR"
# sample url https://www.regelleistung.net/apps/cpp-publisher/api/v1/download/tenders/resultsoverview?date=2024-02-04&exportFormat=xlsx&market=CAPACITY&productTypes=aFRR
...
measurement_name = "capacity_afrr_results"

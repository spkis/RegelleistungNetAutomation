...
base_url = "https://www.regelleistung.net/apps/cpp-publisher/api/v1/download/tenders/demands?date={}&exportFormat=xlsx&market=ENERGY&productTypes=aFRR"
# sample url https://www.regelleistung.net/apps/cpp-publisher/api/v1/download/tenders/demands?date=2024-02-04&exportFormat=xlsx&market=ENERGY&productTypes=aFRR
...
measurement_name = "energy_afrr_demand"
